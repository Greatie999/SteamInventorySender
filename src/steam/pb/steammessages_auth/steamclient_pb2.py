...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CAUTHENTICATION_GETPASSWORDRSAPUBLICKEY_REQUEST.fields_by_name[
        "account_name"
    ]._serialized_options = b"\202\265\0300user-provided account name to get an RSA key for"
    _CAUTHENTICATION_GETPASSWORDRSAPUBLICKEY_RESPONSE.fields_by_name["publickey_mod"]._options = (
        None
    )
    ...
    _CAUTHENTICATION_GETPASSWORDRSAPUBLICKEY_RESPONSE.fields_by_name["publickey_exp"]._options = (
        None
    )
    _CAUTHENTICATION_GETPASSWORDRSAPUBLICKEY_RESPONSE.fields_by_name[
        "publickey_exp"
    ...
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["device_friendly_name"]._serialized_options = (
        b"\202\265\030:User-supplied, or client-supplied, friendly name of device"
    )
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["platform_type"]._options = None
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["platform_type"]._serialized_options = (
        b"\202\265\030*EAuthTokenPlatformType, claimed, of device"
    )
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["os_type"]._options = None
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["os_type"]._serialized_options = (
        b"\202\265\030&EOSType, claimed, of authorized device"
    )
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["gaming_device_type"]._options = None
    _CAUTHENTICATION_DEVICEDETAILS.fields_by_name["gaming_device_type"]._serialized_options = (
        b"\202\265\030NEGamingDeviceType, claimed, of authorized device for steam client-type devices"
    )
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIAQR_REQUEST.fields_by_name[
        ...
        b"\202\265\030<User-supplied details about the device attempting to sign in"
    )
    ...
    _CAUTHENTICATION_ALLOWEDCONFIRMATION.fields_by_name["confirmation_type"]._serialized_options = (
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIAQR_RESPONSE.fields_by_name[
        ...
        b"\202\265\030Iunique identifier of requestor, also used for routing, portion of QR code"
    )
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIAQR_RESPONSE.fields_by_name[
        ...
        b"\202\265\030Grefresh interval with which requestor should call PollAuthSessionStatus"
    )
    _CAUTHENTICATION_BEGINAUTHSESSIONVIAQR_RESPONSE.fields_by_name[
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_REQUEST.fields_by_name[
        "guard_data"
    ]._serialized_options = b"\202\265\030!steam guard data for client login"
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "client_id"
    ]._options = None
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "client_id"
    ]._serialized_options = b"\202\265\0305unique identifier of requestor, also used for routing"
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "request_id"
    ]._options = None
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name["interval"]._options = (
        None
    )
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "interval"
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name["steamid"]._options = (
        None
    )
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "steamid"
    ...
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "agreement_session_url"
    ]._serialized_options = b"\202\265\030$agreement the user needs to agree to"
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "extended_error_message"
    ]._options = None
    _CAUTHENTICATION_BEGINAUTHSESSIONVIACREDENTIALS_RESPONSE.fields_by_name[
        "extended_error_message"
    ]._serialized_options = b"\202\265\0302error string to display if supported by the client"
    ...
    _CAUTHENTICATION_POLLAUTHSESSIONSTATUS_REQUEST.fields_by_name[
        ...
        b"\202\265\030HIf this is set to a token owned by this user, that token will be retired"
    )
    ...
    _CAUTHENTICATION_POLLAUTHSESSIONSTATUS_RESPONSE.fields_by_name[
        "new_client_id"
    ]._serialized_options = b"\202\265\030.if challenge is old, this is the new client id"
    _CAUTHENTICATION_POLLAUTHSESSIONSTATUS_RESPONSE.fields_by_name["new_challenge_url"]._options = (
        None
    )
    _CAUTHENTICATION_POLLAUTHSESSIONSTATUS_RESPONSE.fields_by_name[
        "new_challenge_url"
    ...
    _CAUTHENTICATION_POLLAUTHSESSIONSTATUS_RESPONSE.fields_by_name[
        ...
        b"\202\265\030Fif login has been confirmed, this is the requestor's new refresh token"
    )
    ...
    _CAUTHENTICATION_POLLAUTHSESSIONSTATUS_RESPONSE.fields_by_name[
        "new_guard_data"
    ]._serialized_options = b"\202\265\030Oif login has been confirmed, may contain remembered machine ID for future login"
    _CAUTHENTICATION_GETAUTHSESSIONINFO_REQUEST.fields_by_name["client_id"]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_REQUEST.fields_by_name["client_id"]._serialized_options = (
    ...
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["ip"]._serialized_options = (
        b"\202\265\030\027IP address of requestor"
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["geoloc"]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["geoloc"]._serialized_options = (
        b"\202\265\030\030geoloc info of requestor"
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["city"]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["city"]._serialized_options = (
        b"\202\265\030\021city of requestor"
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["state"]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["state"]._serialized_options = (
        b"\202\265\030\022state of requestor"
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["country"]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["country"]._serialized_options = (
        b"\202\265\030\024country of requestor"
    )
    ...
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["device_friendly_name"]._options = (
        None
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name[
    ...
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["version"]._serialized_options = (
        b"\202\265\030\rversion field"
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name["login_history"]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name[
        "login_history"
    ]._serialized_options = (
        b"\202\265\030Dwhether the ip has previuously been used on the account successfully"
    )
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name[
    ...
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name[
        "high_usage_login"
    ]._serialized_options = b"\202\265\030/whether this login has seen high usage recently"
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name[
        "requested_persistence"
    ]._options = None
    _CAUTHENTICATION_GETAUTHSESSIONINFO_RESPONSE.fields_by_name[
        "requested_persistence"
    ]._serialized_options = b"\202\265\0305session persistence requestor has indicated they want"
    ...
    _CAUTHENTICATION_UPDATEAUTHSESSIONWITHMOBILECONFIRMATION_REQUEST.fields_by_name[
        ...
        b"\202\265\030CHMAC digest over {version,client_id,steamid} via user's private key"
    )
    _CAUTHENTICATION_UPDATEAUTHSESSIONWITHMOBILECONFIRMATION_REQUEST.fields_by_name[
        "confirm"
    ]._options = None
    ...
    _CAUTHENTICATION_UPDATEAUTHSESSIONWITHSTEAMGUARDCODE_REQUEST.fields_by_name["code"]._options = (
        None
    )
    _CAUTHENTICATION_UPDATEAUTHSESSIONWITHSTEAMGUARDCODE_REQUEST.fields_by_name[
        "code"
    ...
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        ...
        b"\202\265\030IApproximate time of history event (may be deliberately fuzzed or omitted)"
    )
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "ip"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "ip"
    ]._serialized_options = b"\202\265\030\036IP at which event was observed"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "country"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "country"
    ]._serialized_options = b"\202\265\0305Location (country code) of event, as inferred from IP"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "state"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "state"
    ]._serialized_options = b"\202\265\0303Location (state code) of event, as inferred from IP"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "city"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_TOKENUSAGEEVENT.fields_by_name[
        "city"
    ]._serialized_options = b"\202\265\030-Location (city) of event, as inferred from IP"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "token_id"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "token_id"
    ]._serialized_options = b'\202\265\030"Persistent token/device identifier'
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "token_description"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "token_description"
    ]._serialized_options = b"\202\265\030,client-supplied friendly name for the device"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "platform_type"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "platform_type"
    ]._serialized_options = b"\202\265\030+gross platform type (mobile/client/browser)"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "logged_in"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "logged_in"
    ]._serialized_options = b"\202\265\030|If true, this token is currently valid. False indicates it is a machine token - ok for steamguard if you know the credential"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "os_platform"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        ...
        b"\202\265\030;EPlatformType - rough classification of device OS, if known"
    )
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "auth_type"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        ...
        b"\202\265\030>EAuthTokenGuardType - device authorization mechanism, if known"
    )
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "gaming_device_type"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "gaming_device_type"
    ]._serialized_options = b"\202\265\030bEGamingDeviceType - classify console/PC/SteamDeck, if known; applies only for Steam Client devices"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "first_seen"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "first_seen"
    ]._serialized_options = b"\202\265\030.Information about original authorization event"
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "last_seen"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        ...
        b"\202\265\030>Information about most-recently seen, if known for this device"
    )
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "os_type"
    ]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION.fields_by_name[
        "os_type"
    ]._serialized_options = b"\202\265\030&EOSType - specific device OS, if known"
    ...
    _CAUTHENTICATION_MIGRATEMOBILESESSION_REQUEST.fields_by_name["steamid"]._serialized_options = (
        b"\202\265\030\037Steam ID of the user to migrate"
    )
    _CAUTHENTICATION_MIGRATEMOBILESESSION_REQUEST.fields_by_name["token"]._options = None
    _CAUTHENTICATION_MIGRATEMOBILESESSION_REQUEST.fields_by_name["token"]._serialized_options = (
        b"\202\265\030\023WG Token to migrate"
    )
    ...
    _CAUTHENTICATION_MIGRATEMOBILESESSION_REQUEST.fields_by_name[
        "signature"
    ]._serialized_options = b"\202\265\0306Signature over the wg token using the user's 2FA token"
    _CAUTHENTICATION_REFRESHTOKEN_REVOKE_REQUEST.fields_by_name["steamid"]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_REVOKE_REQUEST.fields_by_name["steamid"]._serialized_options = (
        b"\202\265\0309Token holder if an admin action on behalf of another user"
    )
    ...
    _CAUTHENTICATION_REFRESHTOKEN_REVOKE_REQUEST.fields_by_name[
        "revoke_action"
    ]._serialized_options = b"\202\265\0303Select between logout and logout-and-forget-machine"
    _CAUTHENTICATION_REFRESHTOKEN_REVOKE_REQUEST.fields_by_name["signature"]._options = None
    _CAUTHENTICATION_REFRESHTOKEN_REVOKE_REQUEST.fields_by_name["signature"]._serialized_options = (
        b"\202\265\030 required signature over token_id"
    )
    ...
    _CAUTHENTICATIONSUPPORT_QUERYREFRESHTOKENSBYACCOUNT_REQUEST.fields_by_name[
        "include_revoked_tokens"
    ]._serialized_options = b"\202\265\0308Includes tokens that are revoked or expired in the query"
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["time"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["time"]._serialized_options = (
        b"\202\265\030IApproximate time of history event (may be deliberately fuzzed or omitted)"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["ip"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["ip"]._serialized_options = (
        b"\202\265\030\036IP at which event was observed"
    )
    ...
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["state"]._serialized_options = (
        b"\202\265\0303Location (state code) of event, as inferred from IP"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["city"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION_TOKENUSAGEEVENT.fields_by_name["city"]._serialized_options = (
        b"\202\265\030-Location (city) of event, as inferred from IP"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["os_platform"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["os_platform"]._serialized_options = (
        b"\202\265\030;EPlatformType - rough classification of device OS, if known"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["os_type"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["os_type"]._serialized_options = (
        b"\202\265\030&EOSType - specific device OS, if known"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["auth_type"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["auth_type"]._serialized_options = (
        b"\202\265\030>EAuthTokenGuardType - device authorization mechanism, if known"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["gaming_device_type"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["gaming_device_type"]._serialized_options = (
        b"\202\265\030bEGamingDeviceType - classify console/PC/SteamDeck, if known; applies only for Steam Client devices"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["first_seen"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["first_seen"]._serialized_options = (
        b"\202\265\030.Information about original authorization event"
    )
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["last_seen"]._options = None
    _CSUPPORTREFRESHTOKENDESCRIPTION.fields_by_name["last_seen"]._serialized_options = (
        b"\202\265\030>Information about most-recently seen, if known for this device"
    )
    ...
    _CAUTHENTICATIONSUPPORT_REVOKETOKEN_REQUEST.fields_by_name["token_id"]._serialized_options = (
        b"\202\265\030*Token ID of the token to revoke (required)"
    )
    _CAUTHENTICATIONSUPPORT_REVOKETOKEN_REQUEST.fields_by_name["steamid"]._options = None
    _CAUTHENTICATIONSUPPORT_REVOKETOKEN_REQUEST.fields_by_name["steamid"]._serialized_options = (
        b"\202\265\030.Steam ID of the owner of that token (required)"
    )
    ...
    _CAUTHENTICATIONSUPPORT_GETTOKENHISTORY_REQUEST.fields_by_name[
        "token_id"
    ]._serialized_options = b"\202\265\0303Token ID of the token to get history for (required)"
    ...
    _AUTHENTICATION.methods_by_name["GetPasswordRSAPublicKey"]._serialized_options = (
        b"\202\265\030KFetches RSA public key to use to encrypt passwords for a given account name"
    )
    _AUTHENTICATION.methods_by_name["BeginAuthSessionViaQR"]._options = None
    _AUTHENTICATION.methods_by_name["BeginAuthSessionViaQR"]._serialized_options = (
        b"\202\265\030\034start authentication process"
    )
    _AUTHENTICATION.methods_by_name["BeginAuthSessionViaCredentials"]._options = None
    _AUTHENTICATION.methods_by_name["BeginAuthSessionViaCredentials"]._serialized_options = (
        b"\202\265\030\034start authentication process"
    )
    _AUTHENTICATION.methods_by_name["PollAuthSessionStatus"]._options = None
    _AUTHENTICATION.methods_by_name["PollAuthSessionStatus"]._serialized_options = (
        b'\202\265\030"poll during authentication process'
    )
    _AUTHENTICATION.methods_by_name["GetAuthSessionInfo"]._options = None
    _AUTHENTICATION.methods_by_name["GetAuthSessionInfo"]._serialized_options = (
        b"\202\265\030Yget metadata of specific auth session, this will also implicitly bind the calling account"
    )
    ...
    ]._serialized_options = b"\202\265\0300approve an authentication session via mobile 2fa"
    _AUTHENTICATION.methods_by_name["UpdateAuthSessionWithSteamGuardCode"]._options = None
    _AUTHENTICATION.methods_by_name["UpdateAuthSessionWithSteamGuardCode"]._serialized_options = (
    ...
    _AUTHENTICATION.methods_by_name["GenerateAccessTokenForApp"]._serialized_options = (
        b"\202\265\030oGiven a refresh token for a client app audience (e.g. desktop client / mobile client), generate an access token"
    )
    _AUTHENTICATION.methods_by_name["EnumerateTokens"]._options = None
    _AUTHENTICATION.methods_by_name["EnumerateTokens"]._serialized_options = (
        b"\202\265\030@Enumerate durable (refresh) tokens for the given subject account"
    )
    _AUTHENTICATION.methods_by_name["GetAuthSessionsForAccount"]._options = None
    _AUTHENTICATION.methods_by_name["GetAuthSessionsForAccount"]._serialized_options = (
        b"\202\265\030LGets all active auth sessions for an account for reference by the mobile app"
    )
    _AUTHENTICATION.methods_by_name["MigrateMobileSession"]._options = None
    _AUTHENTICATION.methods_by_name["MigrateMobileSession"]._serialized_options = (
        b"\202\265\030iMigrates a WG token to an access and refresh token using a signature generated with the user's 2FA secret"
    )
    _AUTHENTICATION.methods_by_name["RevokeRefreshToken"]._options = None
    _AUTHENTICATION.methods_by_name["RevokeRefreshToken"]._serialized_options = (
        b"\202\265\030'Mark the given refresh token as revoked"
    )
    ...
    _AUTHENTICATIONSUPPORT.methods_by_name["QueryRefreshTokensByAccount"]._serialized_options = (
        b"\202\265\030GAsks the server for a list of refresh tokens associated with an account"
    )
    _AUTHENTICATIONSUPPORT.methods_by_name["QueryRefreshTokenByID"]._options = None
    _AUTHENTICATIONSUPPORT.methods_by_name["QueryRefreshTokenByID"]._serialized_options = (
        b"\202\265\030GAsks the server for a list of refresh tokens associated with an account"
    )
    _AUTHENTICATIONSUPPORT.methods_by_name["RevokeToken"]._options = None
    _AUTHENTICATIONSUPPORT.methods_by_name["RevokeToken"]._serialized_options = (
        b"\202\265\030\033Revokes a user's auth token"
    )
    _AUTHENTICATIONSUPPORT.methods_by_name["GetTokenHistory"]._options = None
    _AUTHENTICATIONSUPPORT.methods_by_name["GetTokenHistory"]._serialized_options = (
    ...
    _CLOUDGAMING.methods_by_name["CreateNonce"]._serialized_options = (
    ...
    _CLOUDGAMING.methods_by_name["GetTimeRemaining"]._serialized_options = (
    ...
    _CAUTHENTICATION_REFRESHTOKEN_ENUMERATE_RESPONSE_REFRESHTOKENDESCRIPTION._serialized_start = (
        7909
    )
