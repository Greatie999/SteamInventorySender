...
class CBilling_Address(_message.Message):
    ...
    def __init__(
        ...
        city: _Optional[str] = ...,
        us_state: _Optional[str] = ...,
        country_code: _Optional[str] = ...,
        postcode: _Optional[str] = ...,
        zip_plus4: _Optional[int] = ...,
        phone: _Optional[str] = ...,
    ) -> None: ...
...
class CCDDBAppDetailCommon(_message.Message):
    ...
    def __init__(
        ...
        propagation: _Optional[str] = ...,
        has_adult_content: bool = ...,
        is_visible_in_steam_china: bool = ...,
        app_type: _Optional[int] = ...,
        has_adult_content_sex: bool = ...,
        has_adult_content_violence: bool = ...,
        content_descriptorids: _Optional[_Iterable[int]] = ...,
    ) -> None: ...
...
class CClanEventData(_message.Message):
    ...
    def __init__(
        self,
        gid: _Optional[int] = ...,
        clan_steamid: _Optional[int] = ...,
        event_name: _Optional[str] = ...,
        event_type: _Optional[_Union[EProtoClanEventType, str]] = ...,
        appid: _Optional[int] = ...,
        server_address: _Optional[str] = ...,
        server_password: _Optional[str] = ...,
        rtime32_start_time: _Optional[int] = ...,
        rtime32_end_time: _Optional[int] = ...,
        comment_count: _Optional[int] = ...,
        creator_steamid: _Optional[int] = ...,
        last_update_steamid: _Optional[int] = ...,
        event_notes: _Optional[str] = ...,
        jsondata: _Optional[str] = ...,
        announcement_body: _Optional[_Union[CCommunity_ClanAnnouncementInfo, _Mapping]] = ...,
        published: bool = ...,
        hidden: bool = ...,
        rtime32_visibility_start: _Optional[int] = ...,
        rtime32_visibility_end: _Optional[int] = ...,
        broadcaster_accountid: _Optional[int] = ...,
        follower_count: _Optional[int] = ...,
        ignore_count: _Optional[int] = ...,
        forum_topic_id: _Optional[int] = ...,
        rtime32_last_modified: _Optional[int] = ...,
        news_post_gid: _Optional[int] = ...,
        rtime_mod_reviewed: _Optional[int] = ...,
        featured_app_tagid: _Optional[int] = ...,
        referenced_appids: _Optional[_Iterable[int]] = ...,
        build_id: _Optional[int] = ...,
        build_branch: _Optional[str] = ...,
    ) -> None: ...
...
class CClanEventUserNewsTuple(_message.Message):
    ...
    def __init__(
        ...
        event_gid: _Optional[int] = ...,
        announcement_gid: _Optional[int] = ...,
        rtime_start: _Optional[int] = ...,
        rtime_end: _Optional[int] = ...,
        priority_score: _Optional[int] = ...,
        type: _Optional[int] = ...,
        clamp_range_slot: _Optional[int] = ...,
        appid: _Optional[int] = ...,
        rtime32_last_modified: _Optional[int] = ...,
    ) -> None: ...
...
class CClanMatchEventByRange(_message.Message):
    ...
    def __init__(
        self,
        rtime_before: _Optional[int] = ...,
        rtime_after: _Optional[int] = ...,
        qualified: _Optional[int] = ...,
        events: _Optional[_Iterable[_Union[CClanEventUserNewsTuple, _Mapping]]] = ...,
    ) -> None: ...
...
class CCuratorPreferences(_message.Message):
    ...
    def __init__(
        self,
        supported_languages: _Optional[int] = ...,
        platform_windows: bool = ...,
        platform_mac: bool = ...,
        platform_linux: bool = ...,
        vr_content: bool = ...,
        adult_content_violence: bool = ...,
        adult_content_sex: bool = ...,
        timestamp_updated: _Optional[int] = ...,
        tagids_curated: _Optional[_Iterable[int]] = ...,
        tagids_filtered: _Optional[_Iterable[int]] = ...,
        website_title: _Optional[str] = ...,
        website_url: _Optional[str] = ...,
        discussion_url: _Optional[str] = ...,
        show_broadcast: bool = ...,
    ) -> None: ...
...
class CLocalizationToken(_message.Message):
    ...
    def __init__(
        self,
        language: _Optional[int] = ...,
        localized_string: _Optional[str] = ...,
    ) -> None: ...
...
class CMsgAuthTicket(_message.Message):
    ...
    def __init__(
        self,
        estate: _Optional[int] = ...,
        eresult: _Optional[int] = ...,
        steamid: _Optional[int] = ...,
        gameid: _Optional[int] = ...,
        h_steam_pipe: _Optional[int] = ...,
        ticket_crc: _Optional[int] = ...,
        ticket: _Optional[bytes] = ...,
        server_secret: _Optional[bytes] = ...,
    ) -> None: ...
...
class CMsgGCRoutingProtoBufHeader(_message.Message):
    ...
    def __init__(
        self,
        dst_gcid_queue: _Optional[int] = ...,
        dst_gc_dir_index: _Optional[int] = ...,
    ) -> None: ...
...
class CMsgIPAddressBucket(_message.Message):
    ...
    def __init__(
        self,
        original_ip_address: _Optional[_Union[CMsgIPAddress, _Mapping]] = ...,
        bucket: _Optional[int] = ...,
    ) -> None: ...
...
class CMsgKeyValueSet(_message.Message):
    ...
    def __init__(
        self,
        pairs: _Optional[_Iterable[_Union[CMsgKeyValuePair, _Mapping]]] = ...,
    ) -> None: ...
...
class CMsgMulti(_message.Message):
    ...
    def __init__(
        self,
        size_unzipped: _Optional[int] = ...,
        message_body: _Optional[bytes] = ...,
    ) -> None: ...
...
class CMsgProtoBufHeader(_message.Message):
    ...
    def __init__(
        self,
        steamid: _Optional[int] = ...,
        client_sessionid: _Optional[int] = ...,
        routing_appid: _Optional[int] = ...,
        jobid_source: _Optional[int] = ...,
        jobid_target: _Optional[int] = ...,
        target_job_name: _Optional[str] = ...,
        seq_num: _Optional[int] = ...,
        eresult: _Optional[int] = ...,
        error_message: _Optional[str] = ...,
        auth_account_flags: _Optional[int] = ...,
        token_source: _Optional[int] = ...,
        admin_spoofing_user: bool = ...,
        transport_error: _Optional[int] = ...,
        messageid: _Optional[int] = ...,
        publisher_group_id: _Optional[int] = ...,
        sysid: _Optional[int] = ...,
        trace_tag: _Optional[int] = ...,
        webapi_key_id: _Optional[int] = ...,
        is_from_external_source: bool = ...,
        forward_to_sysid: _Optional[_Iterable[int]] = ...,
        cm_sysid: _Optional[int] = ...,
        launcher_type: _Optional[int] = ...,
        realm: _Optional[int] = ...,
        timeout_ms: _Optional[int] = ...,
        debug_source: _Optional[str] = ...,
        debug_source_string_index: _Optional[int] = ...,
        token_id: _Optional[int] = ...,
        routing_gc: _Optional[_Union[CMsgGCRoutingProtoBufHeader, _Mapping]] = ...,
        ip: _Optional[int] = ...,
        ip_v6: _Optional[bytes] = ...,
    ) -> None: ...
...
class CPackageReservationStatus(_message.Message):
    ...
    def __init__(
        self,
        packageid: _Optional[int] = ...,
        reservation_state: _Optional[int] = ...,
        queue_position: _Optional[int] = ...,
        total_queue_size: _Optional[int] = ...,
        reservation_country_code: _Optional[str] = ...,
        expired: bool = ...,
        time_expires: _Optional[int] = ...,
        time_reserved: _Optional[int] = ...,
    ) -> None: ...
